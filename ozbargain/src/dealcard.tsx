...
export function DealCard({ Title, Img, Time, comments }: { Title: string; Img: string; Time: string; comments: number }) {
  return (
    <Card
      shadow={false}
    ...
    >
      ...
      <CardBody className="relative py-2 px-2 md:px-2" placeholder={null}>
        <Typography
          variant="h5"
          color="white"
